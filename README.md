[![Java CI with Gradle](https://github.com/GorElena/selinede2.2./actions/workflows/gradle.yml/badge.svg)](https://github.com/GorElena/selinede2.2./actions/workflows/gradle.yml)
