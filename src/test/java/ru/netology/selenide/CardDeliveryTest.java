...
public class CardDeliveryTest {
    ...
    public void shouldOrderCardDelivery() {
        ...
        $("[data-test-id='phone'] .input__control").setValue("+79997775551");
    ...
    public void shouldNameWithDash() {
        ...
        $("[data-test-id='city'] .input__control").setValue("Москва");
        $("[data-test-id='date'] .input__control").doubleClick().sendKeys(date);
        $("[data-test-id='name'] .input__control").setValue("Ирина-Мария Петрова");
        $("[data-test-id='phone'] .input__control").setValue("+79997775551");
        $("[data-test-id='agreement']").click();
        $(".button").click();
        $("[data-test-id='notification'] .notification__title").shouldHave(text("Успешно!"),
    ...
    public void shouldEnglishName() {
        ...
        $("[data-test-id='city'] .input__control").setValue("Москва");
        $("[data-test-id='date'] .input__control").doubleClick().sendKeys(date);
        $("[data-test-id='name'] .input__control").setValue("Irina Petrova");
        $("[data-test-id='phone'] .input__control").setValue("+79997775551");
        $("[data-test-id='agreement']").click();
        $(".button").click();
    ...
    public void shouldPhoneWithoutOneNumber() {
        ...
        $("[data-test-id='date'] .input__control").doubleClick().sendKeys(date);
        $("[data-test-id='name'] .input__control").setValue("Ирина Петрова");
        $("[data-test-id='phone'] .input__control").setValue("+7999777555");
        $("[data-test-id='agreement']").click();
        $(".button").click();
        $("[data-test-id='phone'] .input__sub")
                .shouldHave(text("Телефон указан неверно. Должно быть 11 цифр, например, +79012345678."),
    ...
    public void shouldPhonePlusNotInFirstPlace() {
        ...
        $("[data-test-id='date'] .input__control").doubleClick().sendKeys(date);
        $("[data-test-id='name'] .input__control").setValue("Ирина Петрова");
        $("[data-test-id='phone'] .input__control").setValue("7999+7775551");
        $("[data-test-id='agreement']").click();
        $(".button").click();
        $("[data-test-id='phone'] .input__sub")
                .shouldHave(text("Телефон указан неверно. Должно быть 11 цифр, например, +79012345678."),
